...
namespace AlexanderKa.QuantaRouter.WindowsStore.Common
{
    /// <summary>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        public LayoutAwarePage()
        {
            ...
            SetValue(VisibleZoneHeightProperty, height - 70);
            SetValue(VisibleZoneWidthProperty, width - 320);
        ...
        public static readonly DependencyProperty VisibleZoneHeightProperty =
            DependencyProperty.Register("VisibleZoneHeight", typeof(double), typeof(LayoutAwarePage), new PropertyMetadata(default(double)));

        public double VisibleZoneHeight
        {
            get
            {
                return (double)GetValue(VisibleZoneHeightProperty);
            }
            set
            {
                SetValue(VisibleZoneHeightProperty, value);
            }
        }


        public static readonly DependencyProperty VisibleZoneWidthProperty =
           DependencyProperty.Register("VisibleZoneWidth", typeof(double), typeof(LayoutAwarePage), new PropertyMetadata(default(double)));

        public double VisibleZoneWidth
        {
            get
            {
                return (double)GetValue(VisibleZoneWidthProperty);
            }
            set
            {
                SetValue(VisibleZoneWidthProperty, value);
            }
        }
        ...
        {
            SetValue(VisibleZoneHeightProperty, e.Size.Height - 70);
            if (e.Size.Width > 320)
            {
                SetValue(VisibleZoneWidthProperty, e.Size.Width - 320);
            }
